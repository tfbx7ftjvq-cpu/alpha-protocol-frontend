...
10. Build.
11. Devnet scripts.
12. Devnet verification.

Suggested checkpoint criteria:

- After step 1: pure helper tests pass.
- After step 2: account space tests are reviewed.
- After step 4: 299U and 1299U submit tests pass.
- After step 6: payload hash and Security Layer linkage tests pass.
- After step 8: refund and slash accounting tests pass.
- After step 10: IDL is generated by build, but only synced to frontend after the implementation milestone explicitly reaches that stage.
- After step 12: Devnet status document can be updated with signatures and verified addresses.
