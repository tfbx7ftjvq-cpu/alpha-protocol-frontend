# Launch Communication and Community Preheat Plan
...
Alpha Protocol is opening its Public MVP preview for community review.
...
- Green Label Devnet verification dashboard.
- Litepaper draft.
...
No. Current public status is Devnet verified / read-only Public MVP. Mainnet production remains NO-GO until Mainnet readiness checks are complete.

### Is ALPHA token launched?
...
- Small group / early community review.
- Collect UI, narrative, and risk disclosure feedback.
- No public token launch announcement.
- No official token address.

### Phase B: Public MVP Preview

- Publish Landing Page / Litepaper draft.
- Publish X thread.
...
- Not trust private messages.
- Not share seed phrases.
- Not connect to unknown websites.
...
- Landing page screenshots reviewed.
